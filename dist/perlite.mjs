...
const $ = ({ render: template = () => nothing, state: data = {}, target = document.body, ...options }, ...context) => {
    ...
    const effect = (fn, opts) => {
        const handle = computed$1(fn, opts);
        const cancel = () => {
            dispose$1(handle);
